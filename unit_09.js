...
function f3() {
    let outremove = document.querySelector('.out-3');
    outremove.classList.remove('bg-orange');
}
...
let outtoggle = document.querySelector('.out-4');
function f4() {

    outtoggle.classList.toggle('bg-orange');
}
...
function f5() {
    ...
    // outtoggle.classList.contains('bg-orange');
    // out.innerHTML=outtoggle;
    let contains = outtoggle.classList.contains('bg-orange');
    out.innerHTML = contains;
}
...
function f6() {
    ...
    let parag = document.querySelectorAll('.p-6').length;
    out.innerHTML = parag;
    console.log(parag);
}
...
for (let i2 = 0; i2 < div10.length; i2++) {
    div10[i2].onclick = f10;
}
...
out = document.querySelector('.out-15').before(newdiv);
// out.append(newdiv);
...
let out = document.querySelector('.out-16').after(newdiv);
...
newdiv.innerHTML = '17';
newdiv.classList.add('bg-orange');
let out = document.querySelector('.out-17').replaceWith(newdiv);
